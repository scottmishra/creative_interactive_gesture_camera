...
public:
  ...
  PointCloudDownsampler(const int step = 8);

  /*!Sets the desired downsamplingStep to the given value*/
  void setDownsamplingStep(const int step);
  ...
  void downsamplePointCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr& pointCloudPtr,
  ...
  void downsamplePointCloudColor(pcl::PointCloud<pcl::PointXYZRGB>::Ptr&,
