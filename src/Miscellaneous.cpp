...
void generateGlobalMapPtr(std::vector<FrameRGBD*>& keyframes,
                            ...
                            pcl::PointCloud<pcl::PointXYZRGB>::Ptr& globalMapPtr)
  {
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr keyframe;
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr keyframeDownsampled;
    ...
    for(int keyframeIdx=0;keyframeIdx<keyframes.size();keyframeIdx++)
    {
        ...
        pcl::transformPointCloud(*keyframe,alignedCloud,accumulatedPoses[keyframeIdx]);
